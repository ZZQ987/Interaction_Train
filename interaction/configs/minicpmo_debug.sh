...
NODE_COUNT=1
NPROC_PER_NODE=2
LOCAL_NPROC_PER_NODE=2
MASTER_PORT=29645
RJOB_NAME_PREFIX="minicpmo-generated-traj-2gpu-t64-e2-event-clean-mediafix"
...
OUTPUT_NAME_PREFIX="minicpmo2_t64_eval320_e2_l110_lr1e6_l2s0p3_sw3_eventClean_fixedImg448_mediaClean_late1_segTiming"
...
TRAJECTORY_CHUNK_STRIDE=64
EVAL_TRAJECTORY_MAX_TURNS=320
EVAL_TRAJECTORY_CHUNK_STRIDE=320
GENERATED_CHUNK_STRIDE=64
